 ...
 * 날짜 : 2023/06/28
 * 이름 : 김병준
 * 내용 : Java RegularExpression 클래스 실습하기
 */
...
public class RegularExpressionTest {
	public static void main(String[] args) {
		...
		String[] words = {"apple","123한글","123456","011",
		...
		Pattern p2 = Pattern.compile(patt4);
